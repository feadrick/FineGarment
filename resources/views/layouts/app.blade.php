...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <title>Fine Garment</title>
        <!-- Fonts -->
		<link href="https://fonts.googleapis.com/css?family=Raleway:100,600" rel="stylesheet" type="text/css">
		<link href="{{ asset('css/app.css') }}" rel="stylesheet" type="text/css"/>
        <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
        <link  rel="stylesheet" type="text/css" href="{{ asset('css/bootstrap.min.css') }}"/>
        <link  rel="stylesheet" type="text/css" href="{{ asset('css/font-owesome.min.css') }}"/>
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#"><i class="fa fa-envelope-o"></i> FineGarment@gmail.com</a></li>
						<li><a href="#"><i class="fa fa-map-marker"></i> Syeksen 7 Shah Alam</a></li>
					</ul>
